...
요약: 2026-09-21 실제 NAS에서 두 DB 백업·격리 복구·자료 대조·정기 백업 첫 실행을 완료했다. 운영 DB를 덮어쓰거나 앱을 재배포하지 않았다. 후속으로 [실제 VM 재부팅 자동 복구](REBOOT-VERIFICATION-2026-09-21.md)도 검증했다.
...
- VM 정상 재부팅은 후속 검증 완료. 물리 전원 차단과 Proxmox 호스트 재부팅은 미검증.
